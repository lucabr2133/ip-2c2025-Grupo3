...
Luego tambien implemente el heap sort, investigue como siempre, pero empece a tener problemas , cuando quise implementarlo llegaba a un punto que no sabia como resolverlo, asi que investigue mas y entonces me di cuenta que lo que tenia que hacer primero, era separar el ordenamiento en dos fases, una en donde se construia un heap arbol y otra el cual se encargaba del ordenamiento , asi que despues de muchas pruebas pudo hacerlo funcionar,
Despues tambien implemente el shell sort , el cual me costo entenderlo menos, asi que no tuve muchos problemas, investigue e intente hacerlo que funcione por codigo , luego lo implemente en el trabajo y funcionaba perfectamente
salvador lopez ogawa:
